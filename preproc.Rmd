...
set.seed(12345)
x = sample(1010242, 300000, replace = F)
#30% of data for training, 70% for testing
...
```{r}
newsTDMHighFreq = findFreqTerms(newsTDM, lowfreq = 10000, highfreq = Inf)
...
library(ggplot2)
#top 10 words -- counts
qplot(y = news.freq[order(news.freq, decreasing = T)][1:10], x = names(x = news.freq[order(news.freq, decreasing = T)][1:10]), ylab= "Frequency", xlab = "Word", main = "The top 10 words -- counts")
```
