...
getODUnigs = function(bigPre, unigrams) {
        
}


getTrigProbs = function(bigPre, trigrams, bigrams) {
        
}

S3 = getODTrigs(bigPre, trigs) # get observed trigrams and counts
S2 = getODBigs(bigPre, bigrs) # get observed bigrams and counts
